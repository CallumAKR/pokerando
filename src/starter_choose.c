...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_MAREEP)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_PORYGON)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_GRUBBIN )
