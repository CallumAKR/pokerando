...
// Misc. Key Items
    ...
    [ITEM_PARTY_RESTORER] =
    {
        .name = ITEM_NAME("Party Restorer"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Fully restores all\n"
            "living party Pokémon.\n"
            "The dead stay dead."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_PartyRestorer,
        .iconPic = gItemIcon_LargePotion,
        .iconPalette = gItemIconPalette_FullRestore,
    },
    ...
    [ITEM_TIME_TURNER] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_TimeTurner,
        .iconPic = gItemIcon_DubiousDisc,
        .iconPalette = gItemIconPalette_DubiousDisc,
    },
    ...
    [ITEM_WEATHER_SETTER] =
    {
        .name = ITEM_NAME("Weather Setter"),
        .price = 0,
        .description = COMPOUND_STRING(
            "Selects the current\n"
            "location's overworld\n"
            "weather."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_WeatherSetter,
        .iconPic = gItemIcon_DampRock,
        .iconPalette = gItemIconPalette_DampRock,
    },
    ...
    [ITEM_DIG_TOOL] =
    {
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_FIELD,
        .fieldUseFunc = ItemUseOutOfBattle_DigTool,
        .iconPic = gItemIcon_EscapeRope,
        .iconPalette = gItemIconPalette_EscapeRope,
    },
