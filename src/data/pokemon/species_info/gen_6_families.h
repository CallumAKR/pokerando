...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_BIG_PECKS, ABILITY_TURBOBLAZE },
    ...
    [SPECIES_CHESNAUGHT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_HEALER, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Chesnaught"),
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGICIAN, ABILITY_HARVEST, ABILITY_MIRROR_ARMOR },
    ...
    [SPECIES_DELPHOX_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOXIC_BOOST, ABILITY_STORM_DRAIN, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Delphox"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_ROUGH_SKIN, ABILITY_FILTER },
    ...
    [SPECIES_GRENINJA_BATTLE_BOND] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SOLID_ROCK, ABILITY_ICE_SCALES },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Greninja"),
        .cryId = CRY_GRENINJA,
    ...
    [SPECIES_GRENINJA_ASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GLUTTONY, ABILITY_VESSEL_OF_RUIN, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Greninja"),
        .cryId = CRY_GRENINJA,
    ...
    [SPECIES_GRENINJA_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_REGENERATOR, ABILITY_SWORD_OF_RUIN, ABILITY_STEAM_ENGINE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Greninja"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANALYTIC, ABILITY_UNAWARE, ABILITY_COMPOUND_EYES },
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_STATIC, ABILITY_314 },
        .bodyColor = BODY_COLOR_RED,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_AURA_BREAK, ABILITY_ARMOR_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PYROAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_AERILATE, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pyroar"),
    #if P_MODIFIED_MEGA_CRIES
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_FLOETTE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CUD_CHEW, ABILITY_GOOD_AS_GOLD, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Floette"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_UNBURDEN, ABILITY_INNARDS_OUT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .abilities = { ABILITY_LONG_REACH, ABILITY_UNSEEN_FIST, ABILITY_DRIZZLE },
        .bodyColor = BODY_COLOR_WHITE,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx, _overworldAnim)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_FAIRY_AURA, ABILITY_CHLOROPHYLL },
    ...
    [SPECIES_MEOWSTIC_M_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_LINGERING_AROMA, ABILITY_ORICHALCUM_PULSE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Meowstic"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEOWSTIC_F_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ICE_SCALES, ABILITY_SHED_SKIN, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
    #if P_MODIFIED_MEGA_CRIES
        .cryId = CRY_MEOWSTIC_MEGA,
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .abilities = { ABILITY_LIBERO, ABILITY_POISON_PUPPETEER, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_BLADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_MAGNET_PULL, ABILITY_DESOLATE_LAND },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Aegislash"),
        .cryId = CRY_AEGISLASH,
        .natDexNum = NATIONAL_DEX_AEGISLASH,
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_TORRENT, ABILITY_POWER_SPOT, ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK },
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_QUEENLY_MAJESTY, ABILITY_VICTORY_STAR, ABILITY_ROUGH_SKIN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_INKAY] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_BEADS_OF_RUIN, ABILITY_317 },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Inkay"),
        .cryId = CRY_INKAY,
    ...
    [SPECIES_MALAMAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_PIXILATE, ABILITY_PIERCING_DRILL },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Malamar"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .abilities = { ABILITY_SAND_STREAM, ABILITY_COMATOSE, ABILITY_DRAGONIZE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BARBARACLE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_AROMA_VEIL, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Barbaracle"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_QUICK_DRAW, ABILITY_AS_ONE_SHADOW_RIDER, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DRAGALGE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_REGENERATOR, ABILITY_SLOW_START, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Dragalge"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_PROTEAN, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_GALVANIZE, ABILITY_DEFEATIST, ABILITY_NO_GUARD },
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_QUICK_FEET, ABILITY_IRON_FIST, ABILITY_OVERGROW },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_COMPOUND_EYES, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #endif
        .abilities = { ABILITY_NEUROFORCE, ABILITY_WIND_RIDER, ABILITY_THERMAL_EXCHANGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HAWLUCHA_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_PICKPOCKET, ABILITY_PROTEAN },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Hawlucha"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_QUICK_DRAW, ABILITY_PASTEL_VEIL, ABILITY_SYMBIOSIS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_THERMAL_EXCHANGE, ABILITY_ANTICIPATION },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_PIXILATE, ABILITY_THICK_FAT },
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SHARPNESS, ABILITY_SHIELD_DUST, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_PRESSURE, ABILITY_THICK_FAT, ABILITY_COTTON_DOWN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_317, ABILITY_MOXIE, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GOURGEIST_AVERAGE},
    ...
    [SPECIES_PUMPKABOO_SMALL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_DELTA_STREAM, ABILITY_MUMMY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        .cryId = CRY_PUMPKABOO,
        .natDexNum = NATIONAL_DEX_PUMPKABOO,
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GOURGEIST_SMALL},
    ...
    [SPECIES_PUMPKABOO_LARGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_LEVITATE, ABILITY_FULL_METAL_BODY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        .cryId = CRY_PUMPKABOO,
        .natDexNum = NATIONAL_DEX_PUMPKABOO,
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GOURGEIST_LARGE},
    ...
    [SPECIES_PUMPKABOO_SUPER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_PRIMORDIAL_SEA, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pumpkaboo"),
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GOURGEIST_SUPER},
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_STALL, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_VITAL_SPIRIT, ABILITY_MINDS_EYE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_XERNEAS_NEUTRAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_POWER_OF_ALCHEMY, ABILITY_WATER_COMPACTION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_XERNEAS_ACTIVE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GALVANIZE, ABILITY_TECHNICIAN, ABILITY_TRUANT },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Xerneas"),
        .cryId = CRY_XERNEAS,
        .natDexNum = NATIONAL_DEX_XERNEAS,
    ...
    [SPECIES_YVELTAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_HADRON_ENGINE, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ZYGARDE_50] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HUSTLE, ABILITY_GOOEY, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ZYGARDE_50_POWER_CONSTRUCT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_CONTRARY, ABILITY_DEFEATIST },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Zygarde"),
        .cryId = CRY_ZYGARDE_50,
    ...
    [SPECIES_ZYGARDE_10_AURA_BREAK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SKILL_LINK, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Zygarde"),
    ...
    [SPECIES_ZYGARDE_10_POWER_CONSTRUCT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SPICY_SPRAY, ABILITY_VOLT_ABSORB, ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Zygarde"),
        .cryId = CRY_ZYGARDE_10,
    ...
    [SPECIES_ZYGARDE_COMPLETE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Zygarde"),
    ...
    [SPECIES_ZYGARDE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_OVERCOAT, ABILITY_LIQUID_OOZE, ABILITY_AS_ONE_ICE_RIDER },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Zygarde"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_GOOD_AS_GOLD, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_DIANCIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_INSOMNIA, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Diancie"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HOOPA_CONFINED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TRUANT, ABILITY_WIND_POWER, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
    ...
    [SPECIES_HOOPA_UNBOUND] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SIMPLE, ABILITY_DAMP, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Hoopa"),
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_RECEIVER, ABILITY_QUICK_DRAW },
        .bodyColor = BODY_COLOR_BROWN,
