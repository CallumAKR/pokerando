...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_TECHNICIAN, ABILITY_ELECTRIC_SURGE, ABILITY_DRAGONS_MAW },
    ...
    [SPECIES_SCEPTILE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_SCRAPPY, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sceptile"),
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_DOWNLOAD, ABILITY_SUPERSWEET_SYRUP },
    ...
    [SPECIES_BLAZIKEN_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_THERMAL_EXCHANGE, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Blaziken"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_FOREWARN, ABILITY_BAD_DREAMS, ABILITY_NATURAL_CURE },
    ...
    [SPECIES_SWAMPERT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_GOOD_AS_GOLD, ABILITY_NO_GUARD, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Swampert"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_HEALER, ABILITY_SNOW_WARNING },
    #else
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_HEALER, ABILITY_SNOW_WARNING },
    #endif
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_KLUTZ, ABILITY_MOODY, ABILITY_MAGIC_GUARD },
    #else
        .abilities = { ABILITY_KLUTZ, ABILITY_MOODY, ABILITY_MAGIC_GUARD },
    #endif
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_SNOW_WARNING, ABILITY_COSTAR },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Zigzagoon"),
        .cryId = CRY_ZIGZAGOON,
        .natDexNum = NATIONAL_DEX_ZIGZAGOON,
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_SAND_FORCE, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LOTAD] =
    {
        ...
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_HOSPITALITY, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Lotad"),
        .cryId = CRY_LOTAD,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_CUD_CHEW, ABILITY_INNER_FOCUS, ABILITY_PROTOSYNTHESIS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_QUICK_DRAW, ABILITY_HONEY_GATHER, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_MAGIC_BOUNCE, ABILITY_HEALER },
    #else
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_MAGIC_BOUNCE, ABILITY_HEALER },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .abilities = { ABILITY_WATER_VEIL, ABILITY_CURSED_BODY, ABILITY_THERMAL_EXCHANGE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ralts"),
        .cryId = CRY_RALTS,
    ...
    [SPECIES_GARDEVOIR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_LIMBER, ABILITY_KLUTZ, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gardevoir"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GALLADE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = RALTS_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_LIMBER, ABILITY_INFILTRATOR, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Gallade"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_TANGLING_HAIR, ABILITY_AROMA_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOODY, ABILITY_TOXIC_DEBRIS, ABILITY_LIBERO },
    #else
        .abilities = { ABILITY_MOODY, ABILITY_TOXIC_DEBRIS, ABILITY_LIBERO },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SLAKOTH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ARMOR_TAIL, ABILITY_SCREEN_CLEANER, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_RIVALRY, ABILITY_SNOW_WARNING, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_RECKLESS, ABILITY_LIBERO },
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .abilities = { ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, ABILITY_MAGNET_PULL, ABILITY_TANGLING_HAIR },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SWORD_OF_RUIN, ABILITY_IMMUNITY, ABILITY_TURBOBLAZE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_RECEIVER, ABILITY_SYMBIOSIS },
    #else
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_RECEIVER, ABILITY_SYMBIOSIS },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_GRASS_PELT, ABILITY_COTTON_DOWN },
    #else
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_GRASS_PELT, ABILITY_COTTON_DOWN },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SABLEYE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TOXIC_DEBRIS, ABILITY_PICKPOCKET, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sableye"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_ILLUSION, ABILITY_BATTLE_ARMOR },
    ...
    [SPECIES_MAWILE_MEGA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SHADOW_SHIELD, ABILITY_SUPER_LUCK, ABILITY_SHIELD_DUST },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Mawile"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ARON] =
    {
        ...
        .abilities = { ABILITY_SIMPLE, ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_HONEY_GATHER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aron"),
        .cryId = CRY_ARON,
    ...
    [SPECIES_AGGRON_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_PARENTAL_BOND, ABILITY_PRANKSTER, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aggron"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_POISON_POINT, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MEDICHAM_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_CUD_CHEW, ABILITY_CHILLING_NEIGH, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Medicham"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_ANGER_SHELL, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MANECTRIC_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_SIMPLE, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Manectric"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_ORICHALCUM_PULSE, ABILITY_EELEVATE },
    #else
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_ORICHALCUM_PULSE, ABILITY_EELEVATE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MINUN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_DAZZLING, ABILITY_HARVEST, ABILITY_LIQUID_OOZE },
    #else
        .abilities = { ABILITY_DAZZLING, ABILITY_HARVEST, ABILITY_LIQUID_OOZE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_FAIRY_AURA, ABILITY_SHEER_FORCE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_SNIPER, ABILITY_SNOW_CLOAK },
    #else
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_SNIPER, ABILITY_SNOW_CLOAK },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_STEELY_SPIRIT, ABILITY_PURIFYING_SALT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Budew"),
        .cryId = CRY_BUDEW,
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_FLUFFY, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_BATTERY, ABILITY_ROCKY_PAYLOAD, ABILITY_PURIFYING_SALT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHARPEDO_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_MOTOR_DRIVE, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sharpedo"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_FLAME_BODY, ABILITY_TANGLING_HAIR, ABILITY_INTREPID_SWORD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NUMEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FUR_COAT, ABILITY_GOOD_AS_GOLD, ABILITY_CLOUD_NINE },
    #else
        .abilities = { ABILITY_FUR_COAT, ABILITY_GOOD_AS_GOLD, ABILITY_CLOUD_NINE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CAMERUPT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_IMPOSTER, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Camerupt"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_MINUS, ABILITY_SNIPER, ABILITY_VESSEL_OF_RUIN },
    #else
        .abilities = { ABILITY_MINUS, ABILITY_SNIPER, ABILITY_VESSEL_OF_RUIN },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_GRIM_NEIGH, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_WHITE_SMOKE, ABILITY_TRACE, ABILITY_NORMALIZE },
    #else
        .abilities = { ABILITY_WHITE_SMOKE, ABILITY_TRACE, ABILITY_NORMALIZE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        .abilities = { ABILITY_POWER_SPOT, ABILITY_STURDY, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_POWER_SPOT, ABILITY_FAIRY_AURA, ABILITY_POISON_PUPPETEER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_TRUANT, ABILITY_HONEY_GATHER, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ALTARIA_MEGA] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BAD_DREAMS, ABILITY_GUTS, ABILITY_VESSEL_OF_RUIN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Altaria"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANALYTIC, ABILITY_PRISM_ARMOR, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_EARLY_BIRD, ABILITY_GRIM_NEIGH },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SLOW_START, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SOLROCK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_POWER_OF_ALCHEMY, ABILITY_MOXIE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BARBOACH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_IMMUNITY, ABILITY_UNSEEN_FIST, ABILITY_EMERGENCY_EXIT },
    #else
        .abilities = { ABILITY_IMMUNITY, ABILITY_UNSEEN_FIST, ABILITY_EMERGENCY_EXIT },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .abilities = { ABILITY_FLARE_BOOST, ABILITY_IRON_FIST, ABILITY_VITAL_SPIRIT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_UNAWARE, ABILITY_FLAME_BODY, ABILITY_TRACE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_DRIZZLE, ABILITY_FULL_METAL_BODY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ANORITH] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_TRIAGE, ABILITY_314 },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_WATER_COMPACTION, ABILITY_DELTA_STREAM },
    #else
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_WATER_COMPACTION, ABILITY_DELTA_STREAM },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CASTFORM_NORMAL] =
    {
        ...
        .abilities = { ABILITY_SKILL_LINK, ABILITY_DEFIANT, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CASTFORM_SUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_PURIFYING_SALT, ABILITY_EELEVATE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Castform"),
        .cryId = CRY_CASTFORM,
        .natDexNum = NATIONAL_DEX_CASTFORM,
    ...
    [SPECIES_CASTFORM_RAINY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_REFRIGERATE, ABILITY_COSTAR, ABILITY_SHADOW_SHIELD },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Castform"),
        .cryId = CRY_CASTFORM,
        .natDexNum = NATIONAL_DEX_CASTFORM,
    ...
    [SPECIES_CASTFORM_SNOWY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_GRASSY_SURGE, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Castform"),
        .cryId = CRY_CASTFORM,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_GLUTTONY, ABILITY_STEAM_ENGINE, ABILITY_PIXILATE },
    #else
        .abilities = { ABILITY_GLUTTONY, ABILITY_STEAM_ENGINE, ABILITY_PIXILATE },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_UNNERVE, ABILITY_BEAST_BOOST, ABILITY_POISON_POINT },
    #else
        .abilities = { ABILITY_UNNERVE, ABILITY_BEAST_BOOST, ABILITY_POISON_POINT },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BANETTE_MEGA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MINUS, ABILITY_ADAPTABILITY, ABILITY_MYCELIUM_MIGHT },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Banette"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_REFRIGERATE, ABILITY_ROUGH_SKIN, ABILITY_PURIFYING_SALT },
    #else
        .abilities = { ABILITY_REFRIGERATE, ABILITY_ROUGH_SKIN, ABILITY_PURIFYING_SALT },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_GRASS_PELT, ABILITY_SWORD_OF_RUIN },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_GRASS_PELT, ABILITY_SWORD_OF_RUIN },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIGHT_METAL, ABILITY_DEFEATIST, ABILITY_IMPOSTER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHIMECHO_MEGA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_DRAGONIZE, ABILITY_QUEENLY_MAJESTY, ABILITY_HEALER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Chimecho"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ABSOL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_WELL_BAKED_BODY, ABILITY_STENCH },
    #else
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_WELL_BAKED_BODY, ABILITY_STENCH },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ABSOL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANGER_POINT, ABILITY_ILLUMINATE, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ABSOL_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_SOUL_HEART, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Absol"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_SURGE_SURFER, ABILITY_SHADOW_SHIELD },
    #else
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_SURGE_SURFER, ABILITY_SHADOW_SHIELD },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GLALIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_WATER_VEIL, ABILITY_TRUANT, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Glalie"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_FROSLASS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_AIR_LOCK, ABILITY_314, ABILITY_CURIOUS_MEDICINE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Froslass"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TRUANT, ABILITY_PROTOSYNTHESIS, ABILITY_BAD_DREAMS },
    #else
        .abilities = { ABILITY_TRUANT, ABILITY_PROTOSYNTHESIS, ABILITY_BAD_DREAMS },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CLAMPERL] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_HARVEST, ABILITY_GALVANIZE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_RELICANTH] =
    {
        ...
        .abilities = { ABILITY_MAGICIAN, ABILITY_ROCK_HEAD, ABILITY_TOXIC_CHAIN },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_MINUS, ABILITY_STORM_DRAIN, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_INTREPID_SWORD, ABILITY_ANGER_POINT, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
    ...
    [SPECIES_SALAMENCE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_BULLETPROOF, ABILITY_DANCER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Salamence"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_HADRON_ENGINE, ABILITY_GRASSY_SURGE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_METAGROSS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_INNER_FOCUS, ABILITY_ARMOR_TAIL },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Metagross"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_REGIROCK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TOXIC_BOOST, ABILITY_SHARPNESS, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_REGICE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PASTEL_VEIL, ABILITY_PRISM_ARMOR, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_REGISTEEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_KEEN_EYE, ABILITY_MYCELIUM_MIGHT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LATIAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_PERISH_BODY, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LATIAS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_MINUS, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Latias"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STALL, ABILITY_TECHNICIAN, ABILITY_THERMAL_EXCHANGE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LATIOS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_PASTEL_VEIL, ABILITY_VESSEL_OF_RUIN },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Latios"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_KYOGRE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PURE_POWER, ABILITY_MEGA_LAUNCHER, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KYOGRE_PRIMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NO_GUARD, ABILITY_ARMOR_TAIL, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Kyogre"),
    ...
    [SPECIES_GROUDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MULTISCALE, ABILITY_RATTLED, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_GROUDON_PRIMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANALYTIC, ABILITY_AIR_LOCK, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Groudon"),
    ...
    [SPECIES_RAYQUAZA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_CURSED_BODY, ABILITY_VESSEL_OF_RUIN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_RAYQUAZA_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_SHELL_ARMOR, ABILITY_DARK_AURA },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Rayquaza"),
    ...
    [SPECIES_JIRACHI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HYDRATION, ABILITY_WONDER_SKIN, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DEOXYS_NORMAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GORILLA_TACTICS, ABILITY_SKILL_LINK, ABILITY_314 },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DEOXYS_ATTACK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_MAGIC_GUARD, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Deoxys"),
        .cryId = CRY_DEOXYS,
        .natDexNum = NATIONAL_DEX_DEOXYS,
    ...
    [SPECIES_DEOXYS_DEFENSE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ICE_BODY, ABILITY_FRISK, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Deoxys"),
        .cryId = CRY_DEOXYS,
        .natDexNum = NATIONAL_DEX_DEOXYS,
    ...
    [SPECIES_DEOXYS_SPEED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_MOTOR_DRIVE, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Deoxys"),
        .cryId = CRY_DEOXYS,
