...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_STORM_DRAIN, ABILITY_LONG_REACH },
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .abilities = { ABILITY_HUGE_POWER, ABILITY_ROUGH_SKIN, ABILITY_SURGE_SURFER },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_WONDER_SKIN, ABILITY_CORROSION },
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_ANGER_SHELL, ABILITY_RECKLESS },
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EELEVATE, ABILITY_SUPERSWEET_SYRUP, ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GUMSHOOS_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_CURSED_BODY, ABILITY_MUMMY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Gumshoos"),
        .cryId = CRY_GUMSHOOS,
        .natDexNum = NATIONAL_DEX_GUMSHOOS,
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        .abilities = { ABILITY_RECKLESS, ABILITY_PARENTAL_BOND, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK },
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .abilities = { ABILITY_OVERCOAT, ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_WIND_POWER },
    ...
    [SPECIES_CRABOMINABLE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_STEELY_SPIRIT, ABILITY_TRUANT, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Crabominable"),
    ...
    [SPECIES_ORICORIO_BAILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DEFEATIST, ABILITY_HYPER_CUTTER, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ORICORIO_POM_POM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_STALL, ABILITY_MULTISCALE },
    ...
    [SPECIES_ORICORIO_PAU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_STENCH, ABILITY_FLOWER_VEIL, ABILITY_TINTED_LENS },
    ...
    [SPECIES_ORICORIO_SENSU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_CHILLING_NEIGH, ABILITY_TANGLING_HAIR, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Oricorio"),
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .abilities = { ABILITY_PICKPOCKET, ABILITY_TOXIC_CHAIN, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_PROTOSYNTHESIS, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        // Check evening first because it also satisfies the broader
        // "not night" condition used by the Midday form.
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_LYCANROC_DUSK, CONDITIONS({IF_TIME, TIME_EVENING})},
                                {EVO_LEVEL, 25, SPECIES_LYCANROC_MIDDAY, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
    ...
    [SPECIES_WISHIWASHI_SOLO] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_PURE_POWER, ABILITY_MIMICRY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WISHIWASHI_SCHOOL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_MOLD_BREAKER, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Wishiwashi"),
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        .abilities = { ABILITY_POISON_PUPPETEER, ABILITY_STEELWORKER, ABILITY_MAGNET_PULL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_ILLUSION, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_BALL_FETCH, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .abilities = { ABILITY_HUGE_POWER, ABILITY_HUSTLE, ABILITY_GALVANIZE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_PIERCING_DRILL, ABILITY_BATTERY, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_AURA_BREAK, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KLUTZ, ABILITY_PRISM_ARMOR, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BOUNSWEET] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LIBERO, ABILITY_TOXIC_DEBRIS, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_COMFEY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_SCRAPPY, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_OVERGROW, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_PASSIMIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_CURIOUS_MEDICINE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_MEGA_LAUNCHER, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GOLISOPOD_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_TRUANT, ABILITY_PASTEL_VEIL, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Golisopod"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_SLOW_START, ABILITY_GLUTTONY, ABILITY_COTTON_DOWN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PYUKUMUKU] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_CHILLING_NEIGH, ABILITY_RIVALRY, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        .abilities = { ABILITY_PROPELLER_TAIL, ABILITY_STATIC, ABILITY_FAIRY_AURA },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_KOMALA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WIMP_OUT, ABILITY_ANGER_POINT, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_PARENTAL_BOND, ABILITY_LIBERO },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TOGEDEMARU] =
    {
        ...
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_CLOUD_NINE, ABILITY_AROMA_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TOGEDEMARU_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_SUPREME_OVERLORD, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Togedemaru"),
        .cryId = CRY_TOGEDEMARU,
        .natDexNum = NATIONAL_DEX_TOGEDEMARU,
    ...
    [SPECIES_MIMIKYU_DISGUISED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_STEELY_SPIRIT, ABILITY_FRIEND_GUARD, ABILITY_WATER_BUBBLE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MIMIKYU_BUSTED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_HEALER, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Mimikyu"),
        .cryId = CRY_MIMIKYU,
        .natDexNum = NATIONAL_DEX_MIMIKYU,
    ...
    [SPECIES_MIMIKYU_TOTEM_DISGUISED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_LIGHTNING_ROD, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Mimikyu"),
        .cryId = CRY_MIMIKYU,
        .natDexNum = NATIONAL_DEX_MIMIKYU,
    ...
    [SPECIES_MIMIKYU_BUSTED_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_KLUTZ, ABILITY_TANGLING_HAIR, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Mimikyu"),
        .cryId = CRY_MIMIKYU,
        .natDexNum = NATIONAL_DEX_MIMIKYU,
    ...
    [SPECIES_BRUXISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_DELTA_STREAM, ABILITY_RAIN_DISH, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LONG_REACH, ABILITY_RIPEN, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DRAMPA_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BERSERK, ABILITY_MIMICRY, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Drampa"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_DROUGHT, ABILITY_TABLETS_OF_RUIN, ABILITY_DEFEATIST },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_JANGMO_O] =
    {
        ...
        .abilities = { ABILITY_SEED_SOWER, ABILITY_QUICK_FEET, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TAPU_KOKO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHADOW_SHIELD, ABILITY_CLEAR_BODY, ABILITY_ELECTROMORPHOSIS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TAPU_LELE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_WIMP_OUT, ABILITY_TERAVOLT },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TAPU_BULU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_PROTOSYNTHESIS, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TAPU_FINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DESOLATE_LAND, ABILITY_EARTH_EATER, ABILITY_MOTOR_DRIVE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_COSMOG] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_317, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIHILEGO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_TORRENT, ABILITY_NORMALIZE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BUZZWOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_FRISK, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PHEROMOSA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_COMPOUND_EYES, ABILITY_NORMALIZE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_XURKITREE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WIND_POWER, ABILITY_NO_GUARD, ABILITY_GALVANIZE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CELESTEELA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SIMPLE, ABILITY_CLOUD_NINE, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_KARTANA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STALWART, ABILITY_DAZZLING, ABILITY_STICKY_HOLD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GUZZLORD] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_EFFECT_SPORE, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_NECROZMA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_AROMA_VEIL, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_NECROZMA_DUSK_MANE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_WIMP_OUT, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_NECROZMA_DAWN_WINGS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRASS_PELT, ABILITY_SOLAR_POWER, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_NECROZMA_ULTRA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STURDY, ABILITY_ELECTROMORPHOSIS, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Necrozma"),
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIGHT_METAL, ABILITY_IRON_FIST, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MAGEARNA_ORIGINAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_RECKLESS, ABILITY_FLAME_BODY, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Magearna"),
        .cryId = CRY_MAGEARNA,
        .natDexNum = NATIONAL_DEX_MAGEARNA,
    ...
    [SPECIES_MAGEARNA_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SAND_SPIT, ABILITY_AURA_BREAK, ABILITY_DOWNLOAD },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Magearna"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MAGEARNA_ORIGINAL_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HADRON_ENGINE, ABILITY_BERSERK, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Magearna"),
    #if P_MODIFIED_MEGA_CRIES
        .cryId = CRY_MAGEARNA_MEGA,
    ...
    [SPECIES_MARSHADOW] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_PRIMORDIAL_SEA, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_POIPOLE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SAND_SPIT, ABILITY_HONEY_GATHER, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_STAKATAKA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ARMOR_TAIL, ABILITY_BATTERY, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_BLACEPHALON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_SHADOW_TAG, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_ZERAORA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SWARM, ABILITY_PROTEAN, ABILITY_OVERGROW },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ZERAORA_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_UNAWARE, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Zeraora"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ICE_BODY, ABILITY_FILTER, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MELMETAL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NORMALIZE, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MELMETAL_GMAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_RECEIVER, ABILITY_COTTON_DOWN, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Melmetal"),
        .cryId = CRY_MELMETAL,
        .natDexNum = NATIONAL_DEX_MELMETAL,
