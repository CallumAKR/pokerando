...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_TRIAGE, ABILITY_ILLUMINATE, ABILITY_PROTOSYNTHESIS },
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_PIERCING_DRILL, ABILITY_VOLT_ABSORB },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_LEAF_GUARD, ABILITY_TERAVOLT },
    #else
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_LEAF_GUARD, ABILITY_TERAVOLT },
    #endif
    ...
    [SPECIES_STARLY] =
    {
        ...
        .abilities = { ABILITY_PRIMORDIAL_SEA, ABILITY_CHEEK_POUCH, ABILITY_MERCILESS },
    #else
        .abilities = { ABILITY_PRIMORDIAL_SEA, ABILITY_CHEEK_POUCH, ABILITY_MERCILESS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STARAPTOR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_LONG_REACH, ABILITY_HARVEST, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Staraptor"),
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_IMMUNITY, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_STALL, ABILITY_SWIFT_SWIM, ABILITY_VICTORY_STAR },
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_DAZZLING, ABILITY_OPPORTUNIST, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_PRIMORDIAL_SEA, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_FILTER, ABILITY_CUTE_CHARM },
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_VICTORY_STAR, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_WATER_ABSORB, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
        .natDexNum = NATIONAL_DEX_BURMY,
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SUPREME_OVERLORD, ABILITY_ELECTRIC_SURGE, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
        .natDexNum = NATIONAL_DEX_BURMY,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_MEGA_SOL, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_STORM_DRAIN, ABILITY_MERCILESS },
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT, ABILITY_SNOW_CLOAK, ABILITY_LIQUID_OOZE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CHERUBI] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_DESOLATE_LAND, ABILITY_ICE_BODY },
    ...
    [SPECIES_CHERRIM_SUNSHINE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_NEUTRALIZING_GAS, ABILITY_SWIFT_SWIM, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Cherrim"),
        .cryId = CRY_CHERRIM,
        .natDexNum = NATIONAL_DEX_CHERRIM,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_WATER_VEIL, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHELLOS_EAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FOREWARN, ABILITY_PICKUP, ABILITY_LIBERO },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shellos"),
        .cryId = CRY_SHELLOS,
        .natDexNum = NATIONAL_DEX_SHELLOS,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_QUEENLY_MAJESTY, ABILITY_CORROSION },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_314, ABILITY_ANGER_SHELL, ABILITY_FIRE_MANE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_MULTISCALE, ABILITY_DRAGONS_MAW, ABILITY_NEUTRALIZING_GAS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lopunny"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_TANGLED_FEET, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_TORRENT, ABILITY_STALL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_HYPER_CUTTER, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_POWER_OF_ALCHEMY, ABILITY_POISON_TOUCH, ABILITY_WELL_BAKED_BODY },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FLOWER_GIFT, ABILITY_ROCKY_PAYLOAD, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { ABILITY_RIVALRY, ABILITY_ICE_BODY, ABILITY_COLOR_CHANGE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_GARCHOMP_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_UNBURDEN, ABILITY_OPPORTUNIST },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Garchomp"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GARCHOMP_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_POISON_POINT, ABILITY_WIND_POWER, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Garchomp"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STURDY, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_LIMBER, ABILITY_PARENTAL_BOND, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lucario"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LUCARIO_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SNIPER, ABILITY_INNARDS_OUT, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lucario"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PARENTAL_BOND, ABILITY_PIXILATE, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_INTIMIDATE, ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_TRIAGE, ABILITY_PRANKSTER, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_FOREWARN, ABILITY_LINGERING_AROMA },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .abilities = { ABILITY_OPPORTUNIST, ABILITY_SHEER_FORCE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_WATER_COMPACTION, ABILITY_MUMMY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PRESSURE, ABILITY_TERAVOLT, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Abomasnow"),
    #if P_MODIFIED_MEGA_CRIES
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_ROTOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_QUARK_DRIVE, ABILITY_VESSEL_OF_RUIN, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
    ...
    [SPECIES_ROTOM_HEAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_SWIFT_SWIM, ABILITY_SHADOW_TAG },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_TOXIC_CHAIN, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
    ...
    [SPECIES_ROTOM_FROST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_STATIC, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, ABILITY_POISON_HEAL, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_MAGICIAN, ABILITY_CHEEK_POUCH },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
    ...
    [SPECIES_UXIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STICKY_HOLD, ABILITY_PUNK_ROCK, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Uxie"),
        .cryId = CRY_UXIE,
    ...
    [SPECIES_MESPRIT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_SYNCHRONIZE, ABILITY_CLOUD_NINE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_AZELF] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_INSOMNIA, ABILITY_WATER_BUBBLE, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Azelf"),
        .cryId = CRY_AZELF,
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_FRISK, ABILITY_ROCKY_PAYLOAD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SAND_VEIL, ABILITY_GUTS, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Dialga"),
        .cryId = CRY_DIALGA,
        .natDexNum = NATIONAL_DEX_DIALGA,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_FUR_COAT, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LIBERO, ABILITY_TERAVOLT, ABILITY_DROUGHT },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Palkia"),
        .cryId = CRY_PALKIA,
        .natDexNum = NATIONAL_DEX_PALKIA,
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_FRIEND_GUARD, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HEATRAN_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_REFRIGERATE, ABILITY_MISTY_SURGE, ABILITY_TANGLED_FEET },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Heatran"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DAZZLING, ABILITY_SHED_SKIN, ABILITY_WONDER_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PERISH_BODY, ABILITY_DRAGONS_MAW, ABILITY_POWER_OF_ALCHEMY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_GIRATINA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANALYTIC, ABILITY_BEAST_BOOST, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Giratina"),
        .cryId = CRY_GIRATINA,
        .natDexNum = NATIONAL_DEX_GIRATINA,
    ...
    [SPECIES_CRESSELIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_SYNCHRONIZE, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PHIONE] =
    {
        ...
        .abilities = { ABILITY_SHARPNESS, ABILITY_ROCK_HEAD, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SUPERSWEET_SYRUP, ABILITY_TOUGH_CLAWS, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_SLUSH_RUSH, ABILITY_LINGERING_AROMA },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_DARKRAI_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PERISH_BODY, ABILITY_DAZZLING, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Darkrai"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_INTIMIDATE, ABILITY_MEGA_SOL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SHAYMIN_SKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_HUSTLE, ABILITY_ILLUSION },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Shaymin"),
