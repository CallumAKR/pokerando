...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_317, ABILITY_FIRE_MANE, ABILITY_DRAGONS_MAW },
    ...
    [SPECIES_VENUSAUR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_UNNERVE, ABILITY_LIMBER, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Venusaur"),
    ...
    [SPECIES_VENUSAUR_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_COLOR_CHANGE, ABILITY_MAGICIAN },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Venusaur"),
        .cryId = CRY_VENUSAUR,
        .natDexNum = NATIONAL_DEX_VENUSAUR,
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_SYNCHRONIZE, ABILITY_MEGA_LAUNCHER },
...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 109 : 85)
    ...
    [SPECIES_CHARIZARD_MEGA_X] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_GRIM_NEIGH, ABILITY_ICE_SCALES },
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_IRON_BARBS, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Charizard"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CHARIZARD_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_AERILATE, ABILITY_GALE_WINGS, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Charizard"),
        .cryId = CRY_CHARIZARD,
        .natDexNum = NATIONAL_DEX_CHARIZARD,
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_FILTER, ABILITY_AURA_BREAK, ABILITY_DRIZZLE },
...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_BLASTOISE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_PICKUP, ABILITY_STICKY_HOLD },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Blastoise"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_BLASTOISE_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_PROPELLER_TAIL, ABILITY_COSTAR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Blastoise"),
        .cryId = CRY_BLASTOISE,
        .natDexNum = NATIONAL_DEX_BLASTOISE,
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_LIGHT_METAL, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BUTTERFREE_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_POISON_TOUCH, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Butterfree"),
        .cryId = CRY_BUTTERFREE,
        .natDexNum = NATIONAL_DEX_BUTTERFREE,
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_TRANSISTOR, ABILITY_HEATPROOF },
    ...
    [SPECIES_BEEDRILL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STEELWORKER, ABILITY_LIMBER, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Beedrill"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = { ABILITY_HEATPROOF, ABILITY_ILLUMINATE, ABILITY_AIR_LOCK },
    #else
        .abilities = { ABILITY_HEATPROOF, ABILITY_ILLUMINATE, ABILITY_AIR_LOCK },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_PROTEAN, ABILITY_SPICY_SPRAY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pidgeot"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_PRANKSTER, ABILITY_EMERGENCY_EXIT },
    ...
    [SPECIES_RATTATA_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DRIZZLE, ABILITY_INFILTRATOR, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Rattata"),
        .cryId = CRY_RATTATA,
        .natDexNum = NATIONAL_DEX_RATTATA,
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_THICK_FAT, ABILITY_WIND_RIDER, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_EKANS] =
    {
        ...
        .abilities = { ABILITY_COMPETITIVE, ABILITY_HADRON_ENGINE, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ekans"),
        .cryId = CRY_EKANS,
    ...
    [SPECIES_PICHU] =
    {
        ...
        .abilities = { ABILITY_STAMINA, ABILITY_FAIRY_AURA, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
    ...
    [SPECIES_PICHU_SPIKY_EARED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_COTTON_DOWN, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pichu"),
        .cryId = CRY_PICHU,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_PIKACHU_COSPLAY]   =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SOUL_HEART, ABILITY_RUN_AWAY, ABILITY_FIRE_MANE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_ROCK_STAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_STALL, ABILITY_PRIMORDIAL_SEA },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_BELLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_FLARE_BOOST, ABILITY_317 },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
    ...
    [SPECIES_PIKACHU_POP_STAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TANGLED_FEET, ABILITY_MINUS, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
    ...
    [SPECIES_PIKACHU_PHD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_HADRON_ENGINE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_LIBRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_ROCK_HEAD, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_ORIGINAL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BATTERY, ABILITY_COMATOSE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
    ...
    [SPECIES_PIKACHU_HOENN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_SYNCHRONIZE, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_SINNOH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PASTEL_VEIL, ABILITY_HOSPITALITY, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_UNOVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_RAIN_DISH, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_KALOS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DOWNLOAD, ABILITY_SOUNDPROOF, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_LIQUID_OOZE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_PARTNER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MOODY, ABILITY_ANGER_SHELL, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
    ...
    [SPECIES_PIKACHU_WORLD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COSTAR, ABILITY_SURGE_SURFER, ABILITY_LIQUID_OOZE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_SAND_STREAM, ABILITY_WANDERING_SPIRIT },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_PIKACHU_STARTER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DAZZLING, ABILITY_WATER_BUBBLE, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Pikachu"),
        .cryId = CRY_PIKACHU,
        .natDexNum = NATIONAL_DEX_PIKACHU,
    ...
    [SPECIES_RAICHU_MEGA_X] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_BEADS_OF_RUIN, ABILITY_WELL_BAKED_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Raichu"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_RAICHU_MEGA_Y] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_MOLD_BREAKER, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Raichu"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MARVEL_SCALE, ABILITY_MAGIC_BOUNCE, ABILITY_ILLUSION },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNIPER, ABILITY_MOXIE, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandshrew"),
        .cryId = CRY_SANDSHREW,
        .natDexNum = NATIONAL_DEX_SANDSHREW,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUARD_DOG, ABILITY_PROTEAN, ABILITY_BAD_DREAMS },
    #else
        .abilities = { ABILITY_GUARD_DOG, ABILITY_PROTEAN, ABILITY_BAD_DREAMS },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_POISON_POINT, ABILITY_GUARD_DOG, ABILITY_COLOR_CHANGE },
    #else
        .abilities = { ABILITY_POISON_POINT, ABILITY_GUARD_DOG, ABILITY_COLOR_CHANGE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MULTISCALE, ABILITY_STEADFAST, ABILITY_HEAVY_METAL },
    #else
        .abilities = { ABILITY_MULTISCALE, ABILITY_STEADFAST, ABILITY_HEAVY_METAL },
    #endif
    ...
    [SPECIES_CLEFABLE_MEGA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_DESOLATE_LAND, ABILITY_EMBODY_ASPECT_TEAL_MASK },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Clefable"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_IRON_FIST, ABILITY_ROCK_HEAD, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VULPIX_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_ANALYTIC, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Vulpix"),
        .cryId = CRY_VULPIX,
        .natDexNum = NATIONAL_DEX_VULPIX,
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .abilities = { ABILITY_TELEPATHY, ABILITY_DARK_AURA, ABILITY_STAMINA },
    #else
        .abilities = { ABILITY_TELEPATHY, ABILITY_DARK_AURA, ABILITY_STAMINA },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_HYPER_CUTTER, ABILITY_DRAGONIZE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_MAGIC_GUARD, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RIVALRY, ABILITY_ILLUMINATE, ABILITY_ADAPTABILITY },
    #else
        .abilities = { ABILITY_RIVALRY, ABILITY_ILLUMINATE, ABILITY_ADAPTABILITY },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_SHARPNESS, ABILITY_UNBURDEN },
    #else
        .abilities = { ABILITY_COTTON_DOWN, ABILITY_SHARPNESS, ABILITY_UNBURDEN },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_SHELL_ARMOR, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DIGLETT_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_VEIL, ABILITY_WIMP_OUT, ABILITY_AS_ONE_SHADOW_RIDER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Diglett"),
        .cryId = CRY_DIGLETT,
        .natDexNum = NATIONAL_DEX_DIGLETT,
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_AS_ONE_ICE_RIDER, ABILITY_MAGICIAN, ABILITY_INSOMNIA },
    #else
        .abilities = { ABILITY_AS_ONE_ICE_RIDER, ABILITY_MAGICIAN, ABILITY_INSOMNIA },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MEOWTH_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OVERGROW, ABILITY_SUPERSWEET_SYRUP, ABILITY_RATTLED },
    ...
    [SPECIES_MEOWTH_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWARM, ABILITY_TANGLED_FEET, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Meowth"),
        .cryId = CRY_MEOWTH,
        .natDexNum = NATIONAL_DEX_MEOWTH,
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_LINGERING_AROMA, ABILITY_PRISM_ARMOR },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_FULL_METAL_BODY, ABILITY_SHELL_ARMOR },
    #else
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_FULL_METAL_BODY, ABILITY_SHELL_ARMOR },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_WANDERING_SPIRIT, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GROWLITHE_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_PICKUP, ABILITY_RIPEN },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Growlithe"),
        .cryId = CRY_GROWLITHE,
        .natDexNum = NATIONAL_DEX_GROWLITHE,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .abilities = { ABILITY_LIMBER, ABILITY_TRIAGE, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_UNSEEN_FIST, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Abra"),
        .cryId = CRY_ABRA,
    ...
    [SPECIES_ALAKAZAM_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TURBOBLAZE, ABILITY_PRESSURE, ABILITY_HOSPITALITY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Alakazam"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OPPORTUNIST, ABILITY_SIMPLE, ABILITY_CURSED_BODY },
    #else
        .abilities = { ABILITY_OPPORTUNIST, ABILITY_SIMPLE, ABILITY_CURSED_BODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_MACHAMP},
    ...
    [SPECIES_MACHAMP_GMAX] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DESOLATE_LAND, ABILITY_THERMAL_EXCHANGE, ABILITY_THICK_FAT },
    #else
        .abilities = { ABILITY_DESOLATE_LAND, ABILITY_THERMAL_EXCHANGE, ABILITY_THICK_FAT },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_TORRENT, ABILITY_MUMMY, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VICTREEBEL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_DEFIANT, ABILITY_VESSEL_OF_RUIN, ABILITY_BATTERY },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Victreebel"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = { ABILITY_CONTRARY, ABILITY_STORM_DRAIN, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GEODUDE] =
    {
        ...
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_PLUS, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GEODUDE_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_GRIM_NEIGH, ABILITY_SUPREME_OVERLORD, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Geodude"),
        .cryId = CRY_GEODUDE,
        .natDexNum = NATIONAL_DEX_GEODUDE,
    ...
    [SPECIES_GRAVELER_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sGravelerFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GOLEM_ALOLA},
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_SPEED_BOOST, ABILITY_CURIOUS_MEDICINE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEVITATE, ABILITY_STALL, ABILITY_PICKUP },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Ponyta"),
        .cryId = CRY_PONYTA,
        .natDexNum = NATIONAL_DEX_PONYTA,
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_GRIM_NEIGH, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SLOWBRO_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_HEATPROOF, ABILITY_LINGERING_AROMA, ABILITY_GRIM_NEIGH },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Slowbro"),
    ...
    [SPECIES_SLOWPOKE_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_TANGLED_FEET, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Slowpoke"),
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_AFTERMATH, ABILITY_ORICHALCUM_PULSE, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_MINDS_EYE, ABILITY_FLOWER_GIFT },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING, EGG_GROUP_FIELD),
        .abilities = { ABILITY_DAUNTLESS_SHIELD, ABILITY_SAP_SIPPER, ABILITY_TORRENT },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
        .speciesName = _("Farfetch'd"),
        .cryId = CRY_FARFETCHD,
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RIPEN, ABILITY_FLARE_BOOST, ABILITY_AURA_BREAK },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_HONEY_GATHER, ABILITY_TABLETS_OF_RUIN },
    #else
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_HONEY_GATHER, ABILITY_TABLETS_OF_RUIN },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_VICTORY_STAR, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_HARVEST, ABILITY_WHITE_SMOKE, ABILITY_STALL },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Grimer"),
        .cryId = CRY_GRIMER,
        .natDexNum = NATIONAL_DEX_GRIMER,
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MOODY, ABILITY_TINTED_LENS, ABILITY_SHADOW_SHIELD },
    #else
        .abilities = { ABILITY_MOODY, ABILITY_TINTED_LENS, ABILITY_SHADOW_SHIELD },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_POWER_SPOT, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GENGAR},
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_TOXIC_DEBRIS, ABILITY_DOWNLOAD },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Gengar"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_EELEVATE, ABILITY_PRISM_ARMOR, ABILITY_CURIOUS_MEDICINE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_PERISH_BODY, ABILITY_PUNK_ROCK, ABILITY_PRIMORDIAL_SEA },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Steelix"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_317, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_317, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_OPPORTUNIST, ABILITY_DEFEATIST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_KINGLER_GMAX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_TRANSISTOR, ABILITY_OPPORTUNIST, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Kingler"),
        .cryId = CRY_KINGLER,
    ...
    [SPECIES_VOLTORB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_BEAST_BOOST, ABILITY_SLUSH_RUSH, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VOLTORB_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_FLUFFY, ABILITY_SURGE_SURFER, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Voltorb"),
        .cryId = CRY_VOLTORB,
        .natDexNum = NATIONAL_DEX_VOLTORB,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_POISON_POINT, ABILITY_PRIMORDIAL_SEA, ABILITY_TANGLING_HAIR },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_BERSERK, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RECKLESS, ABILITY_IRON_FIST, ABILITY_ICE_BODY },
    #else
        .abilities = { ABILITY_RECKLESS, ABILITY_IRON_FIST, ABILITY_ICE_BODY },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_DOWNLOAD, ABILITY_CLEAR_BODY },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_WONDER_SKIN, ABILITY_SHIELD_DUST },
    #else
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_WONDER_SKIN, ABILITY_SHIELD_DUST },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_POWER_OF_ALCHEMY, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_REFRIGERATE, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUARD_DOG, ABILITY_MUMMY, ABILITY_CURIOUS_MEDICINE },
    #else
        .abilities = { ABILITY_GUARD_DOG, ABILITY_MUMMY, ABILITY_CURIOUS_MEDICINE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_MOODY, ABILITY_TRUANT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KANGASKHAN_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_KLUTZ, ABILITY_FULL_METAL_BODY, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Kangaskhan"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_FULL_METAL_BODY, ABILITY_SHELL_ARMOR },
    #else
        .abilities = { ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_FULL_METAL_BODY, ABILITY_SHELL_ARMOR },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_RATTLED, ABILITY_AROMA_VEIL },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_IRON_FIST, ABILITY_KLUTZ, ABILITY_INTREPID_SWORD },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_STARMIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_PLUS, ABILITY_PROTEAN, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Starmie"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWARM, ABILITY_THERMAL_EXCHANGE, ABILITY_REGENERATOR },
    #else
        .abilities = { ABILITY_SWARM, ABILITY_THERMAL_EXCHANGE, ABILITY_REGENERATOR },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DAMP, ABILITY_SWARM, ABILITY_SAND_VEIL },
    #else
        .abilities = { ABILITY_DAMP, ABILITY_SWARM, ABILITY_SAND_VEIL },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SCIZOR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TORRENT, ABILITY_PROTOSYNTHESIS, ABILITY_HEAVY_METAL },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Scizor"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MINDS_EYE, ABILITY_SOLID_ROCK, ABILITY_ANGER_POINT },
    #else
        .abilities = { ABILITY_MINDS_EYE, ABILITY_SOLID_ROCK, ABILITY_ANGER_POINT },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ANGER_SHELL, ABILITY_BALL_FETCH, ABILITY_STALL },
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_TRANSISTOR, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TORRENT, ABILITY_REGENERATOR, ABILITY_RECKLESS },
    #else
        .abilities = { ABILITY_TORRENT, ABILITY_REGENERATOR, ABILITY_RECKLESS },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PINSIR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_CHEEK_POUCH, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Pinsir"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_JUSTIFIED, ABILITY_THERMAL_EXCHANGE, ABILITY_NATURAL_CURE },
    #else
        .abilities = { ABILITY_JUSTIFIED, ABILITY_THERMAL_EXCHANGE, ABILITY_NATURAL_CURE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WONDER_SKIN, ABILITY_WATER_COMPACTION, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_TAUROS_PALDEA_BLAZE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GRIM_NEIGH, ABILITY_DRAGONS_MAW, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_TAUROS_PALDEA_AQUA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PIERCING_DRILL, ABILITY_ANTICIPATION, ABILITY_RIVALRY },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .abilities = { ABILITY_PURE_POWER, ABILITY_SHARPNESS, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_314, ABILITY_PROTEAN, ABILITY_MYCELIUM_MIGHT },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gyarados"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LAPRAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_EMBODY_ASPECT_TEAL_MASK, ABILITY_QUICK_DRAW, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LAPRAS_GMAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_AS_ONE_SHADOW_RIDER, ABILITY_DESOLATE_LAND },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lapras"),
        .cryId = CRY_LAPRAS,
        .natDexNum = NATIONAL_DEX_LAPRAS,
    ...
    [SPECIES_DITTO] =
    {
        ...
        .abilities = { ABILITY_ICE_SCALES, ABILITY_DEFEATIST, ABILITY_GRASS_PELT },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ditto"),
        .cryId = CRY_DITTO,
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_EEVEE_STARTER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_SCREEN_CLEANER, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Eevee"),
        .cryId = CRY_EEVEE,
        .natDexNum = NATIONAL_DEX_EEVEE,
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WIMP_OUT, ABILITY_STEADFAST, ABILITY_LONG_REACH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_VESSEL_OF_RUIN, ABILITY_DOWNLOAD, ABILITY_AS_ONE_SHADOW_RIDER },
    #else
        .abilities = { ABILITY_VESSEL_OF_RUIN, ABILITY_DOWNLOAD, ABILITY_AS_ONE_SHADOW_RIDER },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_ADAPTABILITY, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_EMBODY_ASPECT_WELLSPRING_MASK, ABILITY_VITAL_SPIRIT, ABILITY_SCREEN_CLEANER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_PERISH_BODY, ABILITY_OVERGROW },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_AERODACTYL_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_BAD_DREAMS, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Aerodactyl"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_RATTLED, ABILITY_INTIMIDATE, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNORLAX_GMAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_COMATOSE, ABILITY_PROTOSYNTHESIS, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Snorlax"),
        .cryId = CRY_SNORLAX,
        .natDexNum = NATIONAL_DEX_SNORLAX,
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MEGA_SOL, ABILITY_PROTEAN, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARTICUNO_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POISON_POINT, ABILITY_317, ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Articuno"),
        .cryId = CRY_ARTICUNO,
        .natDexNum = NATIONAL_DEX_ARTICUNO,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_SWORD_OF_RUIN, ABILITY_DAZZLING, ABILITY_POISON_POINT },
    #else
        .abilities = { ABILITY_SWORD_OF_RUIN, ABILITY_DAZZLING, ABILITY_POISON_POINT },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ZAPDOS_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_SLUSH_RUSH, ABILITY_ORICHALCUM_PULSE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Zapdos"),
        .cryId = CRY_ZAPDOS,
        .natDexNum = NATIONAL_DEX_ZAPDOS,
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FRISK, ABILITY_DAZZLING, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MOLTRES_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_STENCH, ABILITY_ANGER_POINT, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Moltres"),
        .cryId = CRY_MOLTRES,
        .natDexNum = NATIONAL_DEX_MOLTRES,
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_FLUFFY, ABILITY_SAND_SPIT, ABILITY_EMERGENCY_EXIT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONITE_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_DEFEATIST, ABILITY_IMPOSTER, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Dragonite"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_MEGA_LAUNCHER, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MEWTWO_MEGA_X] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_BATTERY, ABILITY_POISON_HEAL, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Mewtwo"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEWTWO_MEGA_Y] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_KLUTZ, ABILITY_TANGLED_FEET, ABILITY_TANGLING_HAIR },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Mewtwo"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_STEELWORKER, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
