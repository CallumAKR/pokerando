...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_MULTISCALE, ABILITY_SUPREME_OVERLORD, ABILITY_IRON_FIST },
    ...
    [SPECIES_MEGANIUM_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_HEALER, ABILITY_CHLOROPHYLL, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Meganium"),
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_SUPER_LUCK, ABILITY_ROCK_HEAD },
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_NORMALIZE, ABILITY_LIGHTNING_ROD, ABILITY_AERILATE },
    ...
    [SPECIES_FERALIGATR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_HADRON_ENGINE, ABILITY_TOXIC_CHAIN, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Feraligatr"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_AURA_BREAK, ABILITY_NORMALIZE, ABILITY_RECKLESS },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_EELEVATE, ABILITY_STALL },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_LIBERO, ABILITY_MULTISCALE, ABILITY_GRASSY_SURGE },
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_PERISH_BODY, ABILITY_HUSTLE, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_QUICK_FEET, ABILITY_WEAK_ARMOR, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_FLARE_BOOST, ABILITY_FIRE_MANE },
    ...
    [SPECIES_NATU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TANGLED_FEET, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Natu"),
        .cryId = CRY_NATU,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_MINDS_EYE, ABILITY_ROCKY_PAYLOAD, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_PROTEAN, ABILITY_SWIFT_SWIM, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_VESSEL_OF_RUIN, ABILITY_PRISM_ARMOR, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_HYDRATION, ABILITY_TOXIC_CHAIN },
    #else
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_HYDRATION, ABILITY_TOXIC_CHAIN },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SAND_VEIL, ABILITY_RATTLED },
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_DRAGONS_MAW, ABILITY_SHARPNESS, ABILITY_STATIC },
    #else
        .abilities = { ABILITY_DRAGONS_MAW, ABILITY_SHARPNESS, ABILITY_STATIC },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANGER_POINT, ABILITY_VESSEL_OF_RUIN, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Yanma"),
        .cryId = CRY_YANMA,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_QUEENLY_MAJESTY, ABILITY_MEGA_SOL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_KLUTZ, ABILITY_WONDER_SKIN, ABILITY_ORICHALCUM_PULSE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wooper"),
        .cryId = CRY_WOOPER,
        .natDexNum = NATIONAL_DEX_WOOPER,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STAMINA, ABILITY_DRAGONS_MAW, ABILITY_DELTA_STREAM },
    #else
        .abilities = { ABILITY_STAMINA, ABILITY_DRAGONS_MAW, ABILITY_DELTA_STREAM },
    #endif
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_TOXIC_CHAIN, ABILITY_SUPER_LUCK, ABILITY_WEAK_ARMOR },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CHILLING_NEIGH, ABILITY_PASTEL_VEIL, ABILITY_WIND_POWER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_NO_GUARD, ABILITY_COMATOSE, ABILITY_DAUNTLESS_SHIELD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_SUPER_LUCK, ABILITY_HOSPITALITY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_314, ABILITY_HYDRATION, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TRUANT, ABILITY_SHIELD_DUST, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_BLAZE, ABILITY_WANDERING_SPIRIT },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_SUPERSWEET_SYRUP, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_ICE_BODY, ABILITY_CUTE_CHARM, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
        .speciesName = _("Qwilfish"),
        .cryId = CRY_QWILFISH,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_IMMUNITY, ABILITY_FLASH_FIRE, ABILITY_SERENE_GRACE },
    #else
        .abilities = { ABILITY_IMMUNITY, ABILITY_FLASH_FIRE, ABILITY_SERENE_GRACE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_PRISM_ARMOR, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_MIMICRY, ABILITY_SPEED_BOOST, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Heracross"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DROUGHT, ABILITY_POWER_OF_ALCHEMY, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_VITAL_SPIRIT, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Sneasel"),
        .cryId = CRY_SNEASEL,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_AFTERMATH, ABILITY_CONTRARY, ABILITY_PURE_POWER },
    #else
        .abilities = { ABILITY_AFTERMATH, ABILITY_CONTRARY, ABILITY_PURE_POWER },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_REGION, REGION_HISUI}, {IF_TIME, TIME_NIGHT})},
                                {EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA, CONDITIONS({IF_REGION, REGION_HISUI})}),
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_IRON_FIST, ABILITY_SAND_FORCE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_TANGLED_FEET, ABILITY_SAND_RUSH },
    #else
        .abilities = { ABILITY_MAGNET_PULL, ABILITY_TANGLED_FEET, ABILITY_SAND_RUSH },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_MARVEL_SCALE, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_DELTA_STREAM, ABILITY_MULTISCALE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Corsola"),
        .cryId = CRY_CORSOLA,
        .natDexNum = NATIONAL_DEX_CORSOLA,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TRUANT, ABILITY_TABLETS_OF_RUIN, ABILITY_STORM_DRAIN },
    #else
        .abilities = { ABILITY_TRUANT, ABILITY_TABLETS_OF_RUIN, ABILITY_STORM_DRAIN },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_SWEET_VEIL, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_SCREEN_CLEANER, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_FLARE_BOOST, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_PUNK_ROCK, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skarmory"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_SEED_SOWER, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNBURDEN, ABILITY_MISTY_SURGE, ABILITY_ICE_BODY },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FOREWARN, ABILITY_TRUANT, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_STEELY_SPIRIT, ABILITY_AERILATE },
    #else
        .abilities = { ABILITY_BEADS_OF_RUIN, ABILITY_STEELY_SPIRIT, ABILITY_AERILATE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_COMPETITIVE, ABILITY_GOOD_AS_GOLD, ABILITY_PASTEL_VEIL },
    #else
        .abilities = { ABILITY_COMPETITIVE, ABILITY_GOOD_AS_GOLD, ABILITY_PASTEL_VEIL },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_FUR_COAT, ABILITY_SERENE_GRACE },
    #else
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_FUR_COAT, ABILITY_SERENE_GRACE },
    #endif
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_MAGIC_GUARD, ABILITY_BLAZE },
    #else
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_MAGIC_GUARD, ABILITY_BLAZE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_PROTEAN, ABILITY_WIMP_OUT, ABILITY_ANGER_POINT },
    #else
        .abilities = { ABILITY_PROTEAN, ABILITY_WIMP_OUT, ABILITY_ANGER_POINT },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_RIPEN, ABILITY_STEAM_ENGINE },
    #else
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_RIPEN, ABILITY_STEAM_ENGINE },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_NORMALIZE, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STENCH, ABILITY_INTIMIDATE, ABILITY_LEAF_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Tyranitar"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_SPEED_BOOST, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_SUPREME_OVERLORD, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGICIAN, ABILITY_SWARM, ABILITY_PRISM_ARMOR },
        .bodyColor = BODY_COLOR_GREEN,
