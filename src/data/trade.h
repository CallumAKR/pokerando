...
static const struct InGameTrade sIngameTrades[] =
{
    [INGAME_TRADE_SEEDOT] =
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_PORYGON_Z
    },
    [INGAME_TRADE_PLUSLE] =
    {
        .nickname = _("PLUSES"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_KORAIDON
    },
    [INGAME_TRADE_HORSEA] =
    {
        .nickname = _("SEASOR"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_SKIDDO
    },
    [INGAME_TRADE_MEOWTH] =
    {
        .nickname = _("MEOWOW"),
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_MUNKIDORI
    },
    [INGAME_TRADE_MR_MIME] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_STUNFISK
    },
    [INGAME_TRADE_JYNX] = 
    {
        .nickname = _("ZYNX"),
    ...
    [INGAME_TRADE_NIDORAN] = 
    {
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_ROTOM_MOW
#else
        .nickname = _("MR. NIDO"),
    ...
    [INGAME_TRADE_FARFETCHD] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_GASTRODON_EAST
    },
    ...
    [INGAME_TRADE_LICKITUNG] = 
    {
        ...
        .sheen = 10,
#if defined(FIRERED)
        .requestedSpecies = SPECIES_RAGING_BOLT
#else
    ...
    [INGAME_TRADE_ELECTRODE] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_LEAFEON
    },
    [INGAME_TRADE_TANGELA] = 
    {
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_FLORGES_BLUE
    },
    [INGAME_TRADE_SEEL] = 
    {
        .nickname = _("SEELOR"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_BUZZWOLE
    }
};
