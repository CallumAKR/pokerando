...
static void PrepareBagForWallyTutorial(void)
{
    ...
    memcpy(sTempWallyBag->bagPocket_Items, gSaveBlock3Ptr->bag.items, sizeof(gSaveBlock3Ptr->bag.items));
    memcpy(sTempWallyBag->bagPocket_PokeBalls, gSaveBlock3Ptr->bag.pokeBalls, sizeof(gSaveBlock3Ptr->bag.pokeBalls));
    ...
    memset(gSaveBlock3Ptr->bag.items, 0, sizeof(gSaveBlock3Ptr->bag.items));
    memset(gSaveBlock3Ptr->bag.pokeBalls, 0, sizeof(gSaveBlock3Ptr->bag.pokeBalls));
...
static void RestoreBagAfterWallyTutorial(void)
{
    ...
    memcpy(gSaveBlock3Ptr->bag.items, sTempWallyBag->bagPocket_Items, sizeof(sTempWallyBag->bagPocket_Items));
    memcpy(gSaveBlock3Ptr->bag.pokeBalls, sTempWallyBag->bagPocket_PokeBalls, sizeof(sTempWallyBag->bagPocket_PokeBalls));
